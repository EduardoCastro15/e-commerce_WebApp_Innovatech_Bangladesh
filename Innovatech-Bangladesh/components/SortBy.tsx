...
const SortBy = () => {
  ...
  return (
    <div className="flex items-center gap-x-5 max-lg:flex-col max-lg:w-full max-lg:items-start">
      <h3 className="text-xl">অনুসারে সাজান:</h3>
      <select
        defaultValue={sortBy}
        ...
        name="sort"
      >
        <option value="defaultSort">ডিফল্ট</option>
        <option value="titleAsc">A-Z সাজান</option>
        <option value="titleDesc">Z-A সাজান</option>
        <option value="lowPrice">সর্বনিম্ন মূল্য</option>
        <option value="highPrice">সর্বোচ্চ দাম</option>
      </select>
    </div>
  );
};
