...
const Filters = () => {
  ...
  return (
    <div>
      <h3 className="text-2xl mb-2">ফিল্টার</h3>
      <div className="divider"></div>
      <div className="flex flex-col gap-y-1">
        <h3 className="text-xl mb-2">প্রাপ্যতা</h3>
        <div className="form-control">
          <label className="cursor-pointer flex items-center">
            <input
              ...
              className="checkbox"
            />
            <span className="label-text text-lg ml-2 text-black">স্টকে</span>
          </label>
        </div>
      ...
      <div className="divider"></div>
      <div className="flex flex-col gap-y-1">
        <h3 className="text-xl mb-2">দাম</h3>
        <div>
          <input
            type="range"
            min={0}
          ...
          />
          <span>{`সর্বোচ্চ মূল্য: $${inputCategory.priceFilter.value}`}</span>
        </div>
      </div>
      ...
      <div>
        <h3 className="text-xl mb-2">সর্বনিম্ন রেটিং:</h3>
        <input
          type="range"
          min={0}
          max="5"
